...
describe('Stack (Array-based)', () => {
  ...
  describe('constructor', () => {
    ...
    it('should create stack with initial items', () => {
      const initStack = new Stack<number>([1, 2, 3]);

      expect(initStack.size()).toBe(3);
      expect(initStack.toArray()).toEqual([3, 2, 1]); // Top to bottom
    });

    it('should create independent copy of initial items', () => {
      const items = [1, 2, 3];
      const initStack = new Stack<number>(items);
      items.push(4);
  ...
  describe('push', () => {
    ...
    it('should handle pushing null values', () => {
      const nullStack = new Stack<number | null>();
      nullStack.push(null);
    ...
    it('should handle pushing undefined values', () => {
      const undefinedStack = new Stack<number | undefined>();
